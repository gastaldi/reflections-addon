== reflections
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The reflections addon enables blah blah...)
...
----
<dependency>
   <groupId>com.george.addon</groupId>
